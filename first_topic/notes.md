...
# 6.Responsible AI solution
1. Map potential harms that are relevant to your planned solution.
    1. Identify potential harms: offensive content, factual inaccuracies, encourages illegal/unethical behavior
    2. Prioritize identified harms: Assess likelihood and impact
    3. Test and verify the prioritized harms: Red team testing for example
    4. Document and share the verified harms

2. Measure the presence of these harms in the outputs generated by your solution.
    1. Prepare input prompts that are likely to result in each potential harm
...
3. Mitigate the harms at multiple layers in your solution to minimize their presence and impact, and ensure transparent communication about potential risks to users.
    1. Model layer: Select an appropiate model for the intended solution or fine-tune
    2. Safety system layer: platform-level configurations and capabilities -> Foundry guardrails -> prompt shields and content filters
    3. System message and grounding layer: RAG, promp engineering -> construction of prompts that are submitted to the model
    4. User experience layer: Desing UI to contrain input to specific subjects
4. Manage the solution responsibly by defining and following a deployment and operational readiness plan
    - Complete prerelease reviews: identify compliance requirements in your organization
    - Realease and operate the solution: e.g phased delivery plan to enable solution to limited users, incident response plan, rollback plan, etc
